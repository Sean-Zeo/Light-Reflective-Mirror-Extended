...
namespace LightReflectiveMirror
{
    public partial class RelayHandler
    {
        ...
        private void CreateRoom(int clientId, int maxPlayers, string serverName, bool isPublic, string serverData, string lobbyName, bool useDirectConnect, string hostLocalIP, bool useNatPunch, int port)
        {
            LeaveRoom(clientId);
